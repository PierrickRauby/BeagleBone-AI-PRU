 ...
 * Created Jan 2021 by Pierrick Rauby
 * Modified by Pierrick Rauby < PierrickRauby - pierrick.rauby@gmail.com > 
 * Based on the cloud9 examples:
 * When triggered by the user space the pru code samples the given address and 
 * returns the value at the adress to the user space using rpmsg
 * To compile use: make 
